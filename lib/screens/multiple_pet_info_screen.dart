...
class _MultiplePetInfoScreenState extends State<MultiplePetInfoScreen> {
  ...
  void initState() {
    ...
    _selectedPetTypes = List.generate(widget.petCount, (index) => null);
    _selectedPetBreeds = List.generate(widget.petCount, (index) => null);
    _selectedPetAges = List.generate(widget.petCount, (index) => null);
  }
    ...
    for (int i = 0; i < widget.petCount; i++) {
      if (_nameControllers[i].text.isEmpty ||
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text("Please fill all details for pet ${i + 1}")),
        );
        return;
      }
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Column(
                    children: List.generate(widget.petCount, (index) {
                      return Container(
