                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      const SizedBox(height: 8),
                      Text("Pet Connect", style: textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.w800)),
                      Text("Find care • meet pet lovers", style: textTheme.bodyMedium),
                    ],
                  ),
                  const Spacer(),
                  // Welcome card
                  Card(
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text("Welcome!", style: textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w800)),
                          const SizedBox(height: 6),
                          Text("Tap Login or Sign Up to continue.",
